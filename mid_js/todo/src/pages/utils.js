let menu_html=`<div class="left">
            ...
            <div class="part today">
                ...
                <div class="box today">
                    ...
                    <label for="today">Add your plans for today</label>
                </div>
            </div>
            <hr>
            <div class="part tomorrow">
                ...
                <div class="box tomorrow">
                    ...
                    <label for="tomorrow">Add your plans for tomorrow</label>
                </div>
            </div>
            <hr>
            <div class="part this_week">
                ...
                <div class="box this_week">
                    ...
                    <label for="this_week">Add your plans for this week</label>
                </div>
            </div>
            <hr>
            <div class="part this_month">
                ...
                <div class="box this_month">
                    ...
                    <label for="this_month">Add your plans for this month</label>
                </div>
            </div>
            ...
            <form id="add_form"> 
                <fieldset>
                    ...
                    <div class="box">
                        ...
                        <input type="text" id="title" name="title" placeholder="Hit the Gym">
                    </div>
                    <div class="box">
                        <label for="project">Project:</label>
                        <input type="text" id="project" name="project" placeholder="Health">
                    </div>
                    <div class="box">
                        <label for="tasks">Tasks:</label>
                        <textarea id="tasks" name="tasks" placeholder="Just Go Hit the Gym M8."></textarea>
                    </div>
                    <div class="box">
                    ...
                    <div class="box priority">
                        ...
                        <div class="priority">
                            <div class="choices">
                            <button type="button" class="low" data-level=1></button>
                            <button type="button" class="mid" data-level=2></button>
                            <button type="button" class="high" data-level=3></button>
                            </div>
                        </div>
                    </div>
...
export function load_html(){
    ...
    subtitle.textContent="Create, Update and Check your To Do List here:"
